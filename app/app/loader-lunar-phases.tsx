/**
 * LoaderLunarPhasesScreen — Showcase du loader Lunar Phases.
...
import { LoaderLunarPhases } from '@/components/loaders';
...
export default function LoaderLunarPhasesScreen() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        {/* Title */}
        <Text style={s.title}>Loader Lunar Phases</Text>
        <Text style={s.subtitle}>
          Ombre de phase glissant sur le disque — 5 s, arc progressif 6 s.
        </Text>
        ...
        <View style={s.section}>
          ...
          <View style={s.showcase}>
            <LoaderLunarPhases size={200} label="Alignement des phases…" />
          </View>
        </View>
