/**
 * LoaderSaturnScreen — Showcase du loader Saturn.
...
import { LoaderSaturn } from '@/components/loaders';
...
export default function LoaderSaturnScreen() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        {/* Title */}
        <Text style={s.title}>Loader Saturn</Text>
        <Text style={s.subtitle}>
          Planète avec anneau incliné — ring 8 s, lune 4,5 s.
        </Text>
        ...
        <View style={s.section}>
          ...
          <View style={s.showcase}>
            <LoaderSaturn size={200} label="Lecture du ciel…" />
          </View>
        </View>
