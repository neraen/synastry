...
export const PLANETS: PlanetDef[] = [
    ...
    { key: 'Ascendant', name: 'Ascendant', glyph: 'AC', isPoint: true,
        desc: "L'Ascendant est le signe qui se levait à l'horizon est au moment exact de ta naissance — c'est pourquoi l'heure de naissance est si précieuse. Il est la porte d'entrée de ton thème : ton apparence, ton style, ta manière instinctive d'aborder toute situation nouvelle. Là où le Soleil dit qui tu deviens, l'Ascendant dit comment tu arrives — la première impression que tu laisses, souvent avant d'avoir dit un mot. C'est aussi le filtre à travers lequel les autres te découvrent : certains ne verront jamais que lui. Bien vécu, il est un allié : une interface fidèle entre ton monde intérieur et le monde extérieur." },
